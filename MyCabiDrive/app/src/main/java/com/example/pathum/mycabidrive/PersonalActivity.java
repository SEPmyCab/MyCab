...
public class PersonalActivity extends ActionBarActivity implements View.OnClickListener {
    ...
    private static final String FETCH_DRIVER_URL = "http://cabeelk.com/myCab2/fetch_driver.php";
    private static final String SAVE_DRIVER_URL = "http://cabeelk.com/myCab2/save_driver.php";
