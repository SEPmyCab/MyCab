<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var icon = new google.maps.MarkerImage("assets/images/icons/noncertified.png");
            var center = null;
            var map = null;
            var currentPopup;
            ...
            function driverDataTruckNonCertified() {
...
$getDriverDetails = "SELECT * FROM location l,driver d, vehicle v WHERE d.Location_Id=l.Location_Id AND d.Availability='Available' AND l.Vehicle_ID=v.Reg_No AND d.Certification='NOT CERTIFIED' AND v.Type='truck'";
...
*/
    ...
    <body onload="initialize(); driverDataTruckNonCertified(); " style="margin:0px; border:0px; padding:0px;">
        <div id="map"></div>
<nav id="navigation">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      ...
                      <ul class="nav navbar-nav navbar-right">
                        <li><a href="index.php/getlocation_truck_certifiedShow"><span class="glyphicon glyphicon-ok-circle" aria-hidden="true"></span> Certified Drivers</a></li>
                        <li><a href="index.php/getlocation_truck_noncertifiedShow"><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> Non Certified Drivers</a></li>
                      </ul>
