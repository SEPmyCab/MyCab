                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav">
                          <li ><a href="index.php/comments_controller/loaddata"><span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span> How It Works</a></li>
                          <li ><a href="index.php/driverShow"><span class="glyphicon glyphicon-search" aria-hidden="true"></span> Search Drivers</a></li>
                          <li ><a href="index.php/ratingShow"><span class="glyphicon glyphicon-star" aria-hidden="true"></span> Rate Drivers</a></li>
                      </ul>
                      
                      <ul class="nav navbar-nav navbar-right">
                        <li><a href="index.php/reserve_controller"><span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span> Reserve</a></li>
