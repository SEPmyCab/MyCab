<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            var icon = new google.maps.MarkerImage("assets/images/icons/van_icon.png");
            var center = null;
            var map = null;
            var currentPopup;
            ...
            function driverDataVans() {
				...
				$getDriverDetails = "SELECT * FROM location l,driver d, vehicle v WHERE d.Location_Id=l.Location_Id AND d.Availability='Available' AND l.Vehicle_ID=v.Reg_No AND v.Type='van'";
    ...
    <body onload="initialize(); driverDataVans(); " style="margin:0px; border:0px; padding:0px;">
        <div id="map"></div>
		<nav id="navigation">
