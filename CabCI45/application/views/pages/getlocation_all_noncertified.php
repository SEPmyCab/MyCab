<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function driverDataAllNonCertified() {
				...
				$getDriverDetails = "SELECT * FROM location l,driver d, vehicle v WHERE d.Location_Id=l.Location_Id AND d.Availability='Available' AND l.Vehicle_ID=v.Reg_No AND d.Certification='NOT CERTIFIED'";
    ...
    <body onload="initialize(); driverDataAllNonCertified(); " style="margin:0px; border:0px; padding:0px;">
        <div id="map"></div>
		<nav id="navigation">
