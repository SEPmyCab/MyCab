...
$getDriverDetails = "SELECT * FROM location l,driver d, vehicle v WHERE d.Location_Id=l.Location_Id AND Availability='available' AND l.Vehicle_ID=v.Reg_No AND v.Type='car'";
